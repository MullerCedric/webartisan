<?php
add_action('init', 'webart_register_profession_interview', 0);
function webart_register_profession_interview()
{
    register_taxonomy('profession-interview', ['post'], [
        'hierarchical' => true,
        'labels' => [
        ...
        'query_var' => true,
        'rewrite' => array('slug' => 'metiers-interview'),
    ]);
}
