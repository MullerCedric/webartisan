<?php
add_action('init', 'webart_register_language_tutorial', 0);
function webart_register_language_tutorial()
{
    register_taxonomy('language-tutorial', ['post'], [
        'hierarchical' => false,
        'labels' => [
        ...
        'query_var' => true,
        'rewrite' => array('slug' => 'langages-tutos'),
    ]);
}
